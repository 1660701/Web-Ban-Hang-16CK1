...
class SanPham
{
    ...
    public function drawTatCaSanPham($sanpham)
    {
        $html =<<<SANPHAM
        <li>
            <a href="index.php?xem=tatcasanpham&id=$sanpham[MaSP]">
...
SANPHAM;
    ...
    public function drawSanPhamCungLoai($sanpham)
    {
        $html =<<<SANPHAM
        <li>
            <a href="index.php?xem=chitietsanphamcungloaisanpham&id=$sanpham[MaSP]">
            <img src="images/san_pham/10.jpg" width="100" height="100">
            <p>$sanpham[TenSP]</p>
            <p style="color:#F00;"><del>$sanpham[GiaGoc]</del></p>
            <p style="color:#F00;">$sanpham[Gia]</p>
...
SANPHAMF;
    ...
    public function TimLoaiSP($loaisp)
    {
        ...
        $loai=mysqli_query($this->conn,$sql);
        return $loai;
    }
    ...
    public function drawChiTietSP($sanpham)
    {
        ...
        <p>
            ...
            <p>Loại sản phẩm: <?php echo TimLoaiSP($sanpham[LoaiSP]) ?></p>
