...
?>
            <form action="index.php?xem=dangkitk&id=1" method="post" enctype="multipart/form-data">
                        ...
                        <table width="200">
                            ...
                            <tr>
                            <td><div class="g-recaptcha" style="margin:auto" data-sitekey="6Lc4T2oUAAAAAOD-IZIGP-IjGC3LHp5bJbBgsuxu"></div>
                            </td>
                            </tr>
                            <tr>
                                <!-- Quan tâm đến name của button và name của input -->
                                <td colspan="2">
                                    <div align="center">
                                        <input class="button" type="submit" name="dangki" id="dangki" value="Đăng kí">
                                    </div>
                                </td>
                            </tr>
                        </table>
