...
?>
<form action="modules/quanliloaisanpham/xuly.php?id=<?php echo $dong['id_loaisp'] ?>" method="post" enctype="multipart/form-data">
<table width="100%" border="1">
    ...
    <tr>
        ...
        <td><input type="text" name="tenloaisanpham" value=<?php echo $dong['tenloaisp'] ?>></td>
    </tr>
    <tr>
        <td>Thứ tự</td>
