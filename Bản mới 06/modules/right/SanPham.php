...
public function NamSanPhamCungLoai($id_sanpham)
    {
        ...
        $sql = "select * from SanPham where LoaiSP ='$spcl[LoaiSP]' limit 5";
...
SANPHAM;
    ...
    {
        $html =<<<SANPHAMH
        <p style="text-align:center;padding:10px">Năm sản phẩm cùng Nhà Sản Xuất</p>
            <div class="sanphamall">
                <ul>
SANPHAMH;
        return $html;
...
//top 5 san pham cung nha san xuat
    public function NamSanPhamCungNSX($id_sanpham)
    {
        ...
        $sql = "select * from SanPham where NhaSanXuatID ='$spcl[NhaSanXuatID]' limit 5";
